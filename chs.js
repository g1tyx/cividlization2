...
var cnItems = {
    ...
    "No malus for Barbarians (except science" : '土著不沉迷苹果酒，全力发展（科学除外）(机翻)',
    "Small bonuses for AI" : 'AI获得小幅度加成',
    "Start" : '开始',
    "Hunters-Gatherers" : '采猎者',
    "It will not cover every feature of this game, you will need to refer to the help section to get more information." : '教程并未包含这游戏的所有内容,您可以参考帮助页面来获取更多的帮助',
    "Next" : '下一步',
    "No bonuses for AI" : 'AI没有额外加成',
    "Nothing selected" : '没有选择任何东西',
    "Skip" : '跳过',
    "This is a short tutorial to help you get started with this game." : '进行一个简短的教程来帮助您开始游戏',
    "Welcome to Cividlization II !" : '欢迎来到文明放置2',
    "allows you to pause the game." : '您可以暂停游戏',
    "allows you to save your game locally. The game will save every 10s so you don't really have to actively save. You can also export your save to use it on another computer or if you play in private mode." : '您可以保存游戏到本地,并且此游戏每10秒钟自动保存,您也可以导出您的游戏存档到别的电脑或使用离线模式进行游戏',
    "allows you to switch between full screen and windowed." : '您可以选择全屏或者窗口化',
    ...
    "represents the total population of your empire. The more population you have, the more you will be able to produce." : '代表了您帝国的总人口,人口越多,劳力越多',
    "represents your science production. you can see that you are not researching anything at the moment. Try to keep it active as much as possible or you will be left behind!" : '代表了您的科学产出,您可以看到您目前不在研究任何东西,请尝试尽可能的研究,否则您将被AI远远抛下',
    "There will be more stuff in it when you will progress in the game." : '随着游戏的进行您会解锁更多内容',
    "There's already a few interesting information to look at" :'这里已经有了一些有趣的信息',
    "This is the topbar where you can see how your empire is going." : '这是顶部栏,您可以查看您帝国的发展状况',
    "allows you to check all your previous notifications that appeared on screen. You will be notified every time an interesting event happens" : '允许您阅读屏幕上所有曾经显示过的通知。 每当发生有趣的事件时，您都会收到通知',
    "is a very important section since" : '因为这是一个非常重要的部分',
    "is the current screen. It allows you to manage your cities which is the core of your empire" : '是这个界面,它可以让您管理自己帝国的核心城市',
    "is where you will be able to select a science to work on. You can see a small icon" : '在这里您可以选择要研究的科学,您可以看到一个小图标',
    ...
    "This game is completly free but if you like it, you can support the dev there !" : '这款游戏是完全免费的,但是如果您喜欢本游戏,您可以支持开发人员',
    "This is the main menu that will help you access the different screens you need to manage your empire." : '这是主要菜单,你可以通过左侧的各种标签页来帮助您管理您的帝国',
    "which means that your attention is required. In this case it means that there is no science selected and that you should choose one." : '这意味着您需要注意。 在这种情况下，这意味着没有选择科学，您应该尽快选择其中一门。',
    ". It allows you to find all the information you need to play this game." : '.您可以在这里找到玩此游戏所需的所有信息',
    "And now the central part of this screen shows your citizens and what they are doing. There are not a lot of roles at the moment but you will unlock others when you will progress." : '现在，该屏幕的中心部分显示了您的公民及其工作。 目前工作种类不多，但是随着游戏进行将解锁其他工作。',
    "And this is the City Screen where you will be able to manage your cities" : '这是城市页面，您可以在其中管理城市',
    "Let's see what we have in the menu on the left part of this screen" : '让我们看看该屏幕左侧菜单中的内容',
    "represents the food. If you want you city to grow, you will need to meet the requirements for food." : '代表食物。 如果您希望城市发展，则需要填满食物上限，这样就可以获得新的人口',
    ...
    "The autoassign option allows you to let the game allocate citizens automatically. You will find more information about it in the Help section" : "自动分配选项使您可以让游戏自动分配公民。 您可以在帮助中找到有关此选项的更多信息。",
    "They have the same meaning but at the city level." : '它们具有相同的含义，除了在城市等级',
    "You already know those icons" : "您已经知道那些图标",
    "You can find more information about the roles in the help menu." : '您可以在帮助菜单中找到有关职业的更多信息',
    "Alright, now you are ready to start. Just click on Start and watch your food accumulate, your city grow and your empire prosper... or fall appart" : '好了，现在您可以开始了。只需单击开始，然后观察您的食物积聚，您的城市成长，您的帝国繁荣……或沦陷',
    "Don't forget to look at the help pages if you need any help !": '如果您需要任何帮助，请不要忘记查看帮助页面！',
    "Start !" : '开始 !',
    'You can also ask the algorithm to prevent growth by checking the': '您还可以抑制人口增长，通过',
    'You can either allocate your population to specific roles or let the game do it for you by checking the auto-assign option.': '您可以手动将人口分配给特定职业，也可以通过选中自动分配选项让游戏为您完成。',
    'You can set priorities for each type of production.': '您可以为每种生产类型设置优先级。',
    'you don	 run out of': '你用完了',
    "you don	 waste workforce in production/culture/science that can't be used": '您浪费了无法使用的生产/文化/科学领域的劳动力',
    ...
    ", you will be able to queue tech research." : '，您将可以排队进行技术研究。',
    " production" : '生产',
    "will go down depending on the population of a city and can be increased by constructing a few buildings." : '会随着人口增加而下降，并且可以通过建造一些建筑物来增加。',
    "You must be careful to not let health drop too low or your citizens will begin to die from disease." : '您必须小心，不要让健康下降太多，否则您的公民将开始死于疾病。',
    "Your people will be more efficient when they are happy and not so much when they get sad. Be carfeul to keep it not too low or they will revolt and rebel against you!" : '员工高兴时会更有效率，而悲伤时则不会那么有效率。 要小心，不要让它过低，否则他们会起义并反抗您！',
    "What's the point of": '有什么意义',
    'When you die or when you decide to reincarnate, you will lose': '当您死亡或决定转世时，您将会失去',
    'which should make your new life easier!': '这会使您的下一次游戏更轻松！',
    ...
    "Your cities can be pillaged too, so be careful about it !" :'您的城市也可能被掠夺，所以要小心！',
    "You will need it to construct buildings, to recruit troops and to pay for your troops maintenance." : '您将需要它来建造建筑物，招募部队并支付部队维护费用。',
    "You will not be able to store an infinite amount of gold. There is a limit to it which can be increased by constructing various buildings." : '您将无法存储无限量的黄金。 有一个上限，可以通过建造各种建筑物来增加上限',
    "which is a greate way to keep good relations with them while producing gold and culture" : '这是获得黄金和文化的同时还能与他们保持良好关系的好方法',
    'first, then send it to another city by clicking on your city on the world map and selecting "Trade route".' : '首先，然后通过在世界地图上单击您的城市并选择“贸易路线”将其发送到另一个城市',
    "with other" : '和其他',
    "you are not at war with" : '你和下列文明不在战争状态',
    "You are not alone in the world. Other civilizations are present and trying to extend too." : '您并不孤单，其他文明也存在并且也在努力扩展',
    " can be an essential part of your game or not. It depends on how you like to play." : '是否可以成为您游戏的重要组成部分，这取决于您想怎么玩这个游戏',
    "You will want to attack a city for 2 reasons: To pillage it and gain gold or to conquer it." : '您攻击一座城市的目的有两个：掠夺城市并获得金币或征服它',
    "You can capture cities from barbarians or other civilizations the same way." : '您可以用同样的方法来占领土著或其他文明的城市。',
    "A battle is fought in multiple assault" : '一场战斗是由多种攻击组成',
    "Siege units attack first. Siege attack points are used against all defending units defense points. Only ranged units can defend against siege which mean their attack points are used against all the attackers units defense points." : '攻城部队首先攻击，攻城攻击会作用于所有防御单位的防御值，只有远程单位才能反击攻城部队，远程单位的攻击会面对所有攻击部队的防御值',
    ...
    "Ranges units attack second. Defending ranged units can fight back" : '远程部队随后攻击，防御方的远程部队可以反击',
    'To be able to recruit units, you usually have to construct the necessary building.': '为了能够招募单位，您通常必须建造必要的建筑物。',
    'To bring a': '带上',
    'To completly clear the city from ALL troops': '彻底清除所有部队的城市',
    'within your attack.': '在你的攻击中',
    'You are protected from attacks until you get to the Ancient Era, so make sure to recruit enough to defend yourself before entering this era !': '在进入上古时代之前，您会受到战斗保护，因此在进入这个时代之前，请确保招募足够多的部队驻守！',
    'Your cities defense will increase with its population, a few buildings and a few policies': '您的城市防御能力将随着人口，一些建筑物和一些政策的增加而增加',
    'a city, you need': '一个城市，你需要',
    "Defending" : '防御',
    "You can also send them to explore automatically. In that case they will walk around the map, discovering lands in random directions." : '您也可以让他们自动探索，在这种情况下，他们将在地图上自动探索地图',
    ...
    "you will be able to discover new" : '您将能够发现新的',
    ' provides': '提供',
...
var cnPrefix = {
    ...
    'Copper Mine': '铜矿',
    'Culture': '文化',
    'Village has finished the construction of': '已经完成',
    'Player': '文明',
    'Religion': '宗教',
    '': '',
    '': '',
