...
var cnItems = {
    ...
    'Greeks created a trade route between Corinth and 1号': '希腊人在科林斯和1号之间建立了一条贸易路线',
    ...
    'Faith production -': '信仰生产-',
    'for\nhelping with beta-testing this game !': '对于帮助进行Beta版测试该游戏！',
    'and\n': '和',
    'Arequipa\n': '阿雷基帕',
    'Athens\n': '雅典',
    'aussy': '奥西',
    ...
    '(incremental': '(增加',
    '< Rome': '< 罗马',
    'Egyptians created a trade route between Elephantine and': '埃及人创造了一条商路在大象路和',
    ...
    '. The Chateau is an castle with +': '。城堡是一座城堡 +',
...
var cnRegReplace = new Map([
    [/^(.+) has finished the construction of (.+)$/, '$1已完成建设$2'],
    [/^Allowed in (.+)$/, '剩余时间 $1'],
    ...
    [/^Nara (.+)\n$/, '奈良 $1'],
    [/^Osaka (.+)\n$/, '大阪 $1'],
    [/^(.+) has been captured !$/, '$1 已被攻占'],
    [/^(.+) Village (.+)$/, '$1 村庄 $2'],
    [/^Citizen died from disease in (.+)$/, '$1的市民因为瘟疫死去了'],
    [/^(.+) Village (.+)\n$/, '$1 村庄 $2'],
